...
import { PrivateMessageClientToServerInterface, PublicMessageClientToServerInterface, MessageInterface } from './message'
...
export interface ServerToClientEvents {
  ...
  new_public_message: (data: PublicMessageClientToServerInterface)=>void
